    ...
    <form action={action} className="space-y-4 rounded-[2rem] border border-white/10 bg-white/5 p-6">
      ...
      <div className="space-y-2">
        ...
        <h3 className="font-serif text-3xl text-ivory">
          {propertyTitle ? `Consultá por ${propertyTitle}` : "Contanos qué punto cardinal estás buscando"}
        </h3>
      </div>
      ...
      <textarea
        name="message"
        rows={5}
        placeholder="Contanos qué propiedad te interesa, si buscás comprar o alquilar y cómo preferís que te contactemos."
