...
export const metadata: Metadata = {
  title: "Propiedades",
  description: "Explorá inmuebles urbanos y rurales en venta y alquiler con filtros claros y navegación simple.",
};
  ...
  return (
    <div className="min-h-screen bg-night text-ivory">
      ...
      <main className="mx-auto max-w-7xl space-y-10 px-5 py-16 md:px-8">
        <SectionHeading
          eyebrow="Catálogo Cardinal"
          title="Propiedades urbanas y rurales con búsqueda ágil"
          description="Filtrá por operación, ciudad, tipo y búsqueda textual para encontrar oportunidades a tu medida."
        />
